...
Following the hardare models many programming language level
...
the order in which stores propogate from threads
...
\subsubsection{Catch-Fire Semantics and Undefined Behavior}
