...
a soundness of common program transformations, 
...
a soundness of program transformations, 
that is source-to-source transformations of 
code which are applied during 
...
Finally, we discuss reasoning guarantees provided by memory models. 
