...
Optimality of compilation schemes
and local program transformations are relatively well-studied.
\app{I don't understand what it means for ``optimality'' to be ``well-studied''.}
...
models like the \Promising. Reconciling these models with $\sco$ 
