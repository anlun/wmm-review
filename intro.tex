...
memory models.
Thus over the last two decades many memory models have been proposed~%
...
\app{I think that with our new focus we should appeal mostly to researchers and system-level developers,
not application-level developers as it is stated in the first sentence of the paragraph.}
