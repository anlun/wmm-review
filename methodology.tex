...
\todo{
  Outline the subclass of MMs we are considering.
  \cite{Boudol-Gustavo:POPL09} --- generalized memory model based on hierarchial structure of 
  ...
  Cons. Podkopaev \etal mentions it can be hard to adapt C11-style interaction of release/acquire and relaxed atomics.
  ...
  \cite{Boudol-al:EXPRESS12} --- generalized memory model with single operation buffer 
  ...
  Cons. Overly strong barrier semantics for Power according to~\cite{Alglave-al:TOPLAS14}. 
  ...
  \cite{Jagadeesan-el:ESOP10} --- an attempt to fix JMM. 
  ...
  \cite{Crary-Sullivan:POPL15} --- unconvential model, based on idea to allow the programmer 
