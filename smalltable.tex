...
\begin{tabular}{|c|l|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|} % 35
 ...
 LS         &
  ...
  \multicolumn{2}{|c|}{\makecell{Program Order\\Preserving}} 
     &
     % compilation 
  ...
  \multicolumn{2}{|c|}{\makecell{Syntax. Dep.\\Preserving}} 
     &
     % compilation 
  ...
  \multicolumn{2}{|c|}{\makecell{Semantic Dep.\\Preserving}} 
     &
     % compilation 
  ...
  \multicolumn{2}{|c|}{\makecell{Out of\\Thin-Air}} 
     &            
     % compilation 
     \okcelln{3}{3} & \okcelln{3}{3} & \okcelln{3}{3} & \okcelln{3}{3} &
     % reorderings
