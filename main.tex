...
We consider \textbf{Java} memory model\cite{Manson-al:POPL05}
and \textbf{C/C++} memory model~\cite{Boehm-Adve:PLDI08, Batty-al:POPL11}
...
%% TODO: no-thin-air models + OCaml & WASM 
