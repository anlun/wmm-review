...
Contrary to the \CMM, \JSMM gives a fully defined 
semantics to non-atomics 
(\ie not undefined behavior for racy non-atomic accesses).  
...
Saraswat~\etal~\cite{Saraswat-el:PPoPP07} presented a memory model
...
their model is either (1) permits thin-air value or 
