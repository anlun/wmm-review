...
and then formalized and studied extensively by
Lahav~\etal~\cite{Lahav-al:PLDI17}.
...
Lahav~\etal~\cite{Lahav-al:PLDI17} have shown that many 
program transformations remain sound in this case, 
with the obvious exception of load/store reordering itself
(see~\cref{table:summary} for details).
Also this design decision has no performance penalty on x86,
