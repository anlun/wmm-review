...
especially on weak hardware like \ARMv{8}~\cite{Liu-al:PLDI19} 
...
They also do not satisfy external \DRF property.
...
and no data-races, thus under \DRF compliant model 
