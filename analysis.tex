...
In \cref{sec:analysis:other} we also discuss several particular properties 
of models, orthogonal to the main partioning into classes, 
which affect soundness of certain program transformations.
