...
the presence of thin-air reads breaks many fundamental reasoning 
...
to the \cref{ex:lb+data}, except it has 
...
\eupp{cite some paper here?}
A lot of effort has been put to forbid problematic 
thin air outcomes, while still preserving 
efficient compilation mappings and soundness of program trasformations
(see \cref{sec:porf-acyc,,sec:pporf-acyc,,sec:prm-cert}).
Yet it is still interesting to study the OOTA models 
both for historical reasons and also to examine their properties in more detail. 
