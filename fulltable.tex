...
\begin{tabular}{|c|l|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|} % 35
 ...
 % \rotatebox[origin=c]{\rotateAngle}{\makecell{$\lPO\lRF$}}            & 
 ...
 \multirow{5}{*}{\rotatebox[origin=c]{\rotateAngle}{\makecell{$\lPO\lRF$\\acyc}}}   
 ...
 \multirow{2}{*}{\rotatebox[origin=c]{\rotateAngle}{\makecell{$\lPPO\lRF$\\acyc}}}   
 ...
 \multirow{7}{*}{\rotatebox[origin=c]{\rotateAngle}{\makecell{no-OOTA}}}   
