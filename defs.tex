...
\newcommand{\wmark}{\text{\color{yellow!30!black}\ding{55}}}
\newcommand{\qmark}{\text{\color{gray!50!black}\textbf{?}}}

\newcommand{\okcell}{\cellcolor{green!20}\cmark}
\newcommand{\badcell}{\cellcolor{red!10}\xmark}
\newcommand{\unkwcell}{\cellcolor{gray!10}\qmark}
\newcommand{\warncell}{\cellcolor{yellow!20}\wmark}
\newcommand{\nacell}{\cellcolor{green!20}---}

\newcommand{\ldrf}{\cellcolor{green!20}\textsf{loc}}
\newcommand{\edrf}{\cellcolor{green!10}\textsf{ext}}
\newcommand{\idrf}{\cellcolor{yellow!20}\textsf{int}}

\newcommand{\okcelln}[2]{\cellcolor{green!20}\makecell{#1/#2}}
\newcommand{\badcelln}[2]{\cellcolor{red!10}\makecell{#1/#2}}
\newcommand{\warncelln}[2]{\cellcolor{yellow!20}\makecell{#1/#2}}
